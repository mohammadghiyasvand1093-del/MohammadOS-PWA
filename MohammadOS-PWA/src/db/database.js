...
/* =========================
 * v24 — record sync tombstones
 * Keep the remote deletion version locally so a deleted record is not
 * re-applied on every manual pull.
 * ========================= */
db.version(24).stores({
  ...
  syncMeta: "key",
  syncOutbox: "opId, entity, entityId, operation, status, createdAt, nextRetryAt, [entity+entityId]",
  syncTombstones: "[entity+entityId], entity, entityId, version, updatedAt",
});
